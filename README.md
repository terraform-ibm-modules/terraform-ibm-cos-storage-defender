...
| <a name="input_allowed_vpc_crns"></a> [allowed\_vpc\_crns](#input\_allowed\_vpc\_crns) | Comma-separated list of allowed VPC CRNs. This will restrict access to the bucket from only specifically allowed VPC CRNs.  Entering values in this field will result in the creation of a new network zone. | `string` | `null` | no |
