...
| <a name="input_allowed_vpc"></a> [allowed\_vpc](#input\_allowed\_vpc) | List of allowed VPCs. This will restrict access to the bucket from only specifically allowed VPCs.  Entering values in this field will result in the creation of a new network zone. | `list(string)` | `null` | no |
